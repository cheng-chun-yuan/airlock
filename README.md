...
Architecture (中文): [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md). Verified integration details for World ID 4.0 and ENSv2 on Sepolia: [docs/INTEGRATION-NOTES.md](docs/INTEGRATION-NOTES.md).
...
- Hash-chain audit and a Merkle root.
- The Console.
- Docker image.
